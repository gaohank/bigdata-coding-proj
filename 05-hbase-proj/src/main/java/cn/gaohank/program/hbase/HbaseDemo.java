package cn.gaohank.program.hbase;
...
//					Bytes.toBytes(value)); // 封装信息
        ...
        try {
            ...
            for (String v : arr) {
                ...
                filterList.addFilter(new SingleColumnValueFilter(Bytes
                        .toBytes(s[0]), Bytes.toBytes(s[1]), CompareFilter.CompareOp.EQUAL,
                        Bytes.toBytes(s[2])));
    ...
    public static void main(String[] args) {
        HbaseDemo ht = new HbaseDemo();
        ht.insertData("user1", "12", "info", "name", "gaohank");
    }
}
